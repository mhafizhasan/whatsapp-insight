    ...
    <div class="container">
      <div class="header">
        <ul class="nav nav-pills pull-right">
          ...
          <li class="active"><a href="<?php echo base_url('info/contact'); ?>">Contact</a></li>
        </ul>
	 ...
	 <div class="jumbotron">
		...
		<p><?php echo safe_mailto('hello@opendata.com.my'); ?></p>
		<small>we accept bug, coffee, ideas, heart, funder</small>
	 </div>
